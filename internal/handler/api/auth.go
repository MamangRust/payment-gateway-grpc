...
func NewHandlerAuth(router *echo.Echo, client pb.AuthServiceClient, logger logger.LoggerInterface, mapper apimapper.AuthResponseMapper, apiHandler errors.ApiHandler, cache auth_cache.AuthMencache) *authHandleApi {
