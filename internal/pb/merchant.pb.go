...
const file_merchant_proto_rawDesc = "" +
	...
	"\aapi_key\x18\x02 \x01(\tR\x06apiKey2\xae\x19\n" +
	...
	"\x0eUpdateMerchant\x12\x19.pb.UpdateMerchantRequest\x1a\x17.pb.ApiResponseMerchant\"\x00\x12Q\n" +
...
var file_merchant_proto_goTypes = []any{
	...
	(*ApiResponseMerchantDeleteAt)(nil),              // 19: pb.ApiResponseMerchantDeleteAt
...
var file_merchant_proto_depIdxs = []int32{
	...
	3,  // 10: pb.ApiResponseMerchantDeleteAt.data:type_name -> pb.MerchantResponseDeleteAt
	2,  // 11: pb.ApiResponsePaginationMerchant.data:type_name -> pb.MerchantResponse
	37, // 12: pb.ApiResponsePaginationMerchant.pagination:type_name -> pb.PaginationMeta
	3,  // 13: pb.ApiResponsePaginationMerchantDeleteAt.data:type_name -> pb.MerchantResponseDeleteAt
	37, // 14: pb.ApiResponsePaginationMerchantDeleteAt.pagination:type_name -> pb.PaginationMeta
	4,  // 15: pb.ApiResponsePaginationMerchantTransaction.data:type_name -> pb.MerchantTransactionResponse
	37, // 16: pb.ApiResponsePaginationMerchantTransaction.pagination:type_name -> pb.PaginationMeta
	25, // 17: pb.MerchantService.FindAllMerchant:input_type -> pb.FindAllMerchantRequest
	28, // 18: pb.MerchantService.FindByIdMerchant:input_type -> pb.FindByIdMerchantRequest
	29, // 19: pb.MerchantService.FindByApiKey:input_type -> pb.FindByApiKeyRequest
	25, // 20: pb.MerchantService.FindAllTransactionMerchant:input_type -> pb.FindAllMerchantRequest
	33, // 21: pb.MerchantService.FindMonthlyPaymentMethodsMerchant:input_type -> pb.FindYearMerchant
	33, // 22: pb.MerchantService.FindYearlyPaymentMethodMerchant:input_type -> pb.FindYearMerchant
	33, // 23: pb.MerchantService.FindMonthlyAmountMerchant:input_type -> pb.FindYearMerchant
	33, // 24: pb.MerchantService.FindYearlyAmountMerchant:input_type -> pb.FindYearMerchant
	33, // 25: pb.MerchantService.FindMonthlyTotalAmountMerchant:input_type -> pb.FindYearMerchant
	33, // 26: pb.MerchantService.FindYearlyTotalAmountMerchant:input_type -> pb.FindYearMerchant
	26, // 27: pb.MerchantService.FindAllTransactionByMerchant:input_type -> pb.FindAllMerchantTransaction
	34, // 28: pb.MerchantService.FindMonthlyPaymentMethodByMerchants:input_type -> pb.FindYearMerchantById
	34, // 29: pb.MerchantService.FindYearlyPaymentMethodByMerchants:input_type -> pb.FindYearMerchantById
	34, // 30: pb.MerchantService.FindMonthlyAmountByMerchants:input_type -> pb.FindYearMerchantById
	34, // 31: pb.MerchantService.FindYearlyAmountByMerchants:input_type -> pb.FindYearMerchantById
	34, // 32: pb.MerchantService.FindMonthlyTotalAmountByMerchants:input_type -> pb.FindYearMerchantById
	34, // 33: pb.MerchantService.FindYearlyTotalAmountByMerchants:input_type -> pb.FindYearMerchantById
	27, // 34: pb.MerchantService.FindAllTransactionByApikey:input_type -> pb.FindAllMerchantApikey
	35, // 35: pb.MerchantService.FindMonthlyPaymentMethodByApikey:input_type -> pb.FindYearMerchantByApikey
	35, // 36: pb.MerchantService.FindYearlyPaymentMethodByApikey:input_type -> pb.FindYearMerchantByApikey
	35, // 37: pb.MerchantService.FindMonthlyAmountByApikey:input_type -> pb.FindYearMerchantByApikey
	35, // 38: pb.MerchantService.FindYearlyAmountByApikey:input_type -> pb.FindYearMerchantByApikey
	35, // 39: pb.MerchantService.FindMonthlyTotalAmountByApikey:input_type -> pb.FindYearMerchantByApikey
	35, // 40: pb.MerchantService.FindYearlyTotalAmountByApikey:input_type -> pb.FindYearMerchantByApikey
	30, // 41: pb.MerchantService.FindByMerchantUserId:input_type -> pb.FindByMerchantUserIdRequest
	25, // 42: pb.MerchantService.FindByActive:input_type -> pb.FindAllMerchantRequest
	25, // 43: pb.MerchantService.FindByTrashed:input_type -> pb.FindAllMerchantRequest
	...
	18, // 52: pb.MerchantService.FindByIdMerchant:output_type -> pb.ApiResponseMerchant
	18, // 53: pb.MerchantService.FindByApiKey:output_type -> pb.ApiResponseMerchant
	24, // 54: pb.MerchantService.FindAllTransactionMerchant:output_type -> pb.ApiResponsePaginationMerchantTransaction
	11, // 55: pb.MerchantService.FindMonthlyPaymentMethodsMerchant:output_type -> pb.ApiResponseMerchantMonthlyPaymentMethod
	12, // 56: pb.MerchantService.FindYearlyPaymentMethodMerchant:output_type -> pb.ApiResponseMerchantYearlyPaymentMethod
	13, // 57: pb.MerchantService.FindMonthlyAmountMerchant:output_type -> pb.ApiResponseMerchantMonthlyAmount
	14, // 58: pb.MerchantService.FindYearlyAmountMerchant:output_type -> pb.ApiResponseMerchantYearlyAmount
	15, // 59: pb.MerchantService.FindMonthlyTotalAmountMerchant:output_type -> pb.ApiResponseMerchantMonthlyTotalAmount
	16, // 60: pb.MerchantService.FindYearlyTotalAmountMerchant:output_type -> pb.ApiResponseMerchantYearlyTotalAmount
	24, // 61: pb.MerchantService.FindAllTransactionByMerchant:output_type -> pb.ApiResponsePaginationMerchantTransaction
	11, // 62: pb.MerchantService.FindMonthlyPaymentMethodByMerchants:output_type -> pb.ApiResponseMerchantMonthlyPaymentMethod
	12, // 63: pb.MerchantService.FindYearlyPaymentMethodByMerchants:output_type -> pb.ApiResponseMerchantYearlyPaymentMethod
	13, // 64: pb.MerchantService.FindMonthlyAmountByMerchants:output_type -> pb.ApiResponseMerchantMonthlyAmount
	14, // 65: pb.MerchantService.FindYearlyAmountByMerchants:output_type -> pb.ApiResponseMerchantYearlyAmount
	15, // 66: pb.MerchantService.FindMonthlyTotalAmountByMerchants:output_type -> pb.ApiResponseMerchantMonthlyTotalAmount
	16, // 67: pb.MerchantService.FindYearlyTotalAmountByMerchants:output_type -> pb.ApiResponseMerchantYearlyTotalAmount
	24, // 68: pb.MerchantService.FindAllTransactionByApikey:output_type -> pb.ApiResponsePaginationMerchantTransaction
	11, // 69: pb.MerchantService.FindMonthlyPaymentMethodByApikey:output_type -> pb.ApiResponseMerchantMonthlyPaymentMethod
	12, // 70: pb.MerchantService.FindYearlyPaymentMethodByApikey:output_type -> pb.ApiResponseMerchantYearlyPaymentMethod
	13, // 71: pb.MerchantService.FindMonthlyAmountByApikey:output_type -> pb.ApiResponseMerchantMonthlyAmount
	14, // 72: pb.MerchantService.FindYearlyAmountByApikey:output_type -> pb.ApiResponseMerchantYearlyAmount
	15, // 73: pb.MerchantService.FindMonthlyTotalAmountByApikey:output_type -> pb.ApiResponseMerchantMonthlyTotalAmount
	16, // 74: pb.MerchantService.FindYearlyTotalAmountByApikey:output_type -> pb.ApiResponseMerchantYearlyTotalAmount
	17, // 75: pb.MerchantService.FindByMerchantUserId:output_type -> pb.ApiResponsesMerchant
	...
	18, // 78: pb.MerchantService.CreateMerchant:output_type -> pb.ApiResponseMerchant
	18, // 79: pb.MerchantService.UpdateMerchant:output_type -> pb.ApiResponseMerchant
	19, // 80: pb.MerchantService.TrashedMerchant:output_type -> pb.ApiResponseMerchantDeleteAt
	19, // 81: pb.MerchantService.RestoreMerchant:output_type -> pb.ApiResponseMerchantDeleteAt
	20, // 82: pb.MerchantService.DeleteMerchantPermanent:output_type -> pb.ApiResponseMerchantDelete
	21, // 83: pb.MerchantService.RestoreAllMerchant:output_type -> pb.ApiResponseMerchantAll
	21, // 84: pb.MerchantService.DeleteAllMerchantPermanent:output_type -> pb.ApiResponseMerchantAll
