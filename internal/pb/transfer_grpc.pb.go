...
func (c *transferServiceClient) TrashedTransfer(ctx context.Context, in *FindByIdTransferRequest, opts ...grpc.CallOption) (*ApiResponseTransferDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *transferServiceClient) RestoreTransfer(ctx context.Context, in *FindByIdTransferRequest, opts ...grpc.CallOption) (*ApiResponseTransferDeleteAt, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApiResponseTransferDeleteAt)
...
func (UnimplementedTransferServiceServer) TrashedTransfer(context.Context, *FindByIdTransferRequest) (*ApiResponseTransferDeleteAt, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TrashedTransfer not implemented")
}
func (UnimplementedTransferServiceServer) RestoreTransfer(context.Context, *FindByIdTransferRequest) (*ApiResponseTransferDeleteAt, error) {
